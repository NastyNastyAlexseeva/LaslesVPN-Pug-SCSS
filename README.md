...
## Делаем свою ветку с помощью git checkout -b author_name(ваше имя на английском). Делаем пуш только в нее, это ваша рабочая ветка, ветка master только для сборки!
